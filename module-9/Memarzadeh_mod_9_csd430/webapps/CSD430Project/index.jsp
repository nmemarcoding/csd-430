    ...
    <main>
        <section class="nav-container">
            ...
            <ul class="nav-list">
                ...
                <li><a href="CRUD_UpdateDropdown.jsp">Update Record (Dropdown)</a></li>
                <li><a href="CRUD_DeleteDropdown.jsp">Delete Record (Dropdown)</a></li>
            </ul>
        </section>
        ...
        <section class="new-feature">
            ...
            <p>Try our newly added feature to delete state records using a dropdown menu!</p>
            <a href="CRUD_DeleteDropdown.jsp">Delete Record (Dropdown)</a>
        </section>
    </main>
